  ...
  const en = {
    account: {
      ...
      password: {
        label: "Password",
        instruction:
          "There was a problem. Your password must be between 8 to 32 characters, include a mixture of both uppercase and lowercase letters, include a mixture of letters and numbers, and have at least one special character limited to: . ~ ! ? @ # $ % ^ &amp; * ( ) <span>Password cannot contain common patterns such as consecutively repeating a character three or more times, e.g. aaaatf54 or repeating a pattern, e.g. abcabcab</span>",
      },
      verifyPassword: {
