...
export class PersonalPage {
  ...
  constructor(page: Page, appContent?: any) {
    ...
    this.emailHelperText = this.page.getByText(
      appContent?.personal?.email?.instruction ||
        "An email address is required to use many of our digital resources, such as e-books."
    );
