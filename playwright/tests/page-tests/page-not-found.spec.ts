...
test.describe("page not found (404)", { tag: "@regression" }, () => {
  ...
  test("displays breadcrumbs", async () => {
    ...
    await expect(pageNotFoundPage.getALibraryCardBreadcrumb).toBeVisible();
  });
  ...
  test("get a library card breadcrumb navigates to the expected destination", async ({
    ...
    await pageNotFoundPage.getALibraryCardBreadcrumb.click();
