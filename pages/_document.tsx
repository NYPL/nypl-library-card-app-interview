    ...
    return (
      <Html lang="en">
        ...
        <body>
          ...
          <script src={dsHeader} crossOrigin="anonymous" async></script>
          <Main />
          {/* <!-- NYPL Footer Script --> */}
          <div id="nypl-footer"></div>
          <script src={dsFooter} crossOrigin="anonymous" async></script>
          <NextScript />
          {/* <!-- Optimizely --> */}
          <script
            src="https://cdn.optimizely.com/js/284748925.js"
            crossOrigin="anonymous"
          ></script>
          {/* OptinMonster */}
          <script
            dangerouslySetInnerHTML={{
              __html: `(function(d,u,ac){var s=d.createElement('script');s.type='text/javascript';s.src='https://a.omappapi.com/app/js/api.min.js';s.async=true;s.crossOrigin='anonymous';s.dataset.user=u;s.dataset.account=ac;d.getElementsByTagName('head')[0].appendChild(s);})(document,12468,1044);`,
            }}
          />
          {/* 
